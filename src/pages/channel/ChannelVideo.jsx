...
import {VideoList,NoVideoFound} from "../../components"
...
const ChannelVideo=()=>{
    ...
    return(
        <>
            <div className="w-full p-2 dark:text-white flex gap-4">
                <button
                    onClick={()=>{
            ...
            <div className="grid lg:grid-cols-3 sm:grid-cols-2 dark:text-white">
                {videos?.map((video)=>(
                    <VideoList
                        key={video._id}
